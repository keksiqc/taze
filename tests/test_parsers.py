...
class TestParsePyproject:
    ...
    def test_dependency_groups(self, tmp_path):
        p = self._write(
            tmp_path,
            """
            [dependency-groups]
    ...
    def test_uv_dev_dependencies(self, tmp_path):
        p = self._write(
            tmp_path,
            """
            [tool.uv]
...
class TestBuildNameFilter:
    def test_plain_name_matches(self):
